...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://media.discordapp.net/attachments/975720737191129129/1063190237540519936/JukKrMc1.png",
...
Config.Languages = {
  ['en'] = {
        ['emotes'] = "<font face='Fire Sans'>🎈Animace",
        ['danceemotes'] = "<font face='Fire Sans'>🕺 Animace tanců",
        ['propemotes'] = "<font face='Fire Sans'>📦 Prop Animace",
        ['favoriteemotes'] = "<font face='Fire Sans'>🌟 Oblíbené animace",
        ['favoriteinfo'] = "Zde vyberte emoci a nastavte ji jako svou oblibenou.",
        ['rfavorite'] = "Resetetovat oblíbené animace",
        ['prop2info'] = "❓ Prop Emoty mohou byt umisteny na konci",
        ['set'] = 'Nastavit (',
        ['setboundemote'] = ') Byt vasi vazanou emoci?',
        ['newsetemote'] = '~w~ je nyni vasi vazanou emoci, stisknete ~g~CapsLock~w~ pro pouziti.',
        ['cancelemote'] = "<font face='Fire Sans'>❌Ukončit animaci",
        ['cancelemoteinfo'] = '~r~X~w~ Ukonci aktualne delany emote',
        ['walkingstyles'] = "<font face='Fire Sans'>🏃‍♂️Typy chůze",
        ['dogmenu'] = "<font face='Fire Sans'>🐶Dog Menu",
        ['resetdef'] = 'Resetovat',
        ['normalreset'] = 'Normální (reset)',
        ['moods'] = "<font face='Fire Sans'>😀Nálada (obličej)",
        ['notvaliddance'] = 'Neni platny tanec.',
        ['notvalidemote'] = 'Neni platny emote.',
        ['nocancel'] = 'Neni zadny emote k ukonceni.',
        ['maleonly'] = 'Tato emoce je pouze pro muze, omlouvame se!',
        ['emotemenucmd'] = 'Pro nabidku pouzijte /emotemenu.',
        ['shareemotes'] = "<font face='Fire Sans'>👫 Sdílené animace",
        ['shareemotesinfo'] = 'Pozve osobu v okoli, aby se vyjadrila',
        ['sharedanceemotes'] = "<font face='Fire Sans'>🕺 Sdílené tance",
        ['notvalidsharedemote'] = 'Neni platna sdilena animace.',
        ['sentrequestto'] = 'Posle pozvanku pro ~y~',
        ['nobodyclose'] = 'Nikdo neni ~r~kolem~w~ tebe.',
        ['doyouwanna'] = '~y~Y~w~ pro prijmuti, ~r~L~w~ pro odmitnuti (~g~',
        ['refuseemote'] = 'Emote odmitnut.',
        ['makenearby'] = 'Primeje hrace pobliz hrat',
        ['camera'] = 'Pres ~y~G~w~ vyfotite.',
        ['makeitrain'] = 'Pres ~y~G~w~ zacnete sypat prachy xD.',
        ['pee'] = 'Drz ~y~G~w~ pro curani.',
        ['spraychamp'] = 'Drzte ~y~G~w~ pro strikani sampanem',
        ['bound'] = 'Vazany ',
        ['to'] = 'na',
        ['currentlyboundemotes'] = ' Aktualne vazane emoty:',
        ['notvalidkey'] = 'Neni platny bind.',
        ['keybinds'] = "",
        ['keybindsinfo'] = 'Pouzit'
  },
  ['fr'] = {
