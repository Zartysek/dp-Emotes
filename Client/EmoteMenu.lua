...
function AddEmoteMenu(menu)
    ...
    local dogmenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['dogmenu'], "", "", Menuthing, Menuthing)
    ...
    for a,b in pairsByKeys(DP.DOGMENU) do
      x,y,z = table.unpack(b)
      dogitem = NativeUI.CreateItem(z, "/e ("..a..")")
      dogmenu:AddItem(dogitem)
      table.insert(DogTable, a)
    end
    ...
    dogmenu.OnItemSelect = function(sender, item, index)
      EmoteMenuStart(DogTable[index], "dogmenu")
    end
...
function AddDogMenu(menu)
  local submenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['dogmenu'], "", "", Menuthing, Menuthing)
