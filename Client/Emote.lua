...
function EmoteMenuStart(args, hard)
    ...
    elseif etype == "emotes" then
      ...
      elseif etype == "dogmenu" then
        if DP.DOGMENU[name] ~= nil then
          if OnEmotePlay(DP.DOGMENU[name]) then end
        end
...
function EmoteCommandStart(source, args, raw)
    ...
    elseif DP.DOGMENU[name] ~= nil then
      if OnEmotePlay(DP.DOGMENU[name]) then end return
    else
